...
export default function Chatbot() {
      ...
      switch (option) {
        case 'Enquiries':
          response = ` 📩 Please enter your enquiry below.<br><br>
            <strong>Email Us:</strong> <a class="chat-link" href="mailto:churchPortal@gmail.com" target="_blank" rel="noopener noreferrer">churchPortal@gmail.com</a><br>
            <strong>WhatsApp Us:</strong> <a class="chat-link" href="https://wa.me/23350xxxxxxxx" target="_blank" rel="noopener noreferrer">23350xxxxxxxx</a>`;
          break;
        case 'Contacts':
          response = '📱 Send a message to WhatsApp number: <a class="chat-link" href="https://wa.me/23350xxxxxxxx" target="_blank" rel="noopener noreferrer">23350xxxxxxxx</a>';
          break;
        case 'Initiatives':
  ...
  // Handle user text input (send to WhatsApp + Email)
  const sendMessage = () => {
    ...
    // Send to WhatsApp (open link)
    window.open(`https://wa.me/23350xxxxxxxx?text=${encodeURIComponent(input)}`, '_blank');
